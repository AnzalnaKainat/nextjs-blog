  ...
  return (
    <div className="py-20 flex flex-col text-center items-center justify-center ">
        <div className=' text-[#8f8952]'>
          <h1 className='mx-auto w-11/12 font-bold sm:text-6xl text-4xl leading-none tracking-tighter'>
            Stay Ahead in Tech
          </h1>
          <h2 className='my-2 mx-auto w-11/12 text-2xl sm:text-3xl md:text-4xl leading-none tracking-tight'>
            Explore Insights, Innovations, and Industry Trends
          </h2>
          <p  className='my-2 mx-auto md:w-1/2 w-11/12 '>
