...
const PostClient = ({ post }: { post: any }) => {
  ...
  return (
    <>
      {post.imgURL && (
        <div
          className="w-full h-60 sm:h-screen rounded-3xl my-4 bg-cover bg-no-repeat"
          style={{ backgroundImage: `url(${post.imgURL})` }}
        ></div>
      )}
      <div className="p-5 sm:p-10 mx-auto md:-mt-28 sm:-mt-20 -mt-12 bg-[#fffffd] rounded-3xl shadow-lg shadow-indigo-500/40 max-w-5xl">
        ...
        <h1 className="text-2xl sm:text-4xl md:text-5xl my-5 font-bold text-[#8f8952] ">
          {post.title}
        </h1>
      ...
      <p className="p-5 sm:p-10 my-10 max-w-5xl mx-auto">
        {/* {parse(post.content)} */}
...
//       {post.imgURL && (
//         <div
//           className="w-full h-60 sm:h-screen relative rounded-lg my-4 bg-cover bg-no-repeat"
//           style={{ backgroundImage: `url(${post.imgURL})` }}
//         ></div>
//       )}
//       <div className="p-5 sm:p-10 mx-auto bg-[#fffffd] rounded-xl shadow-lg shadow-indigo-500/40 max-w-6xl">
//         <div className="flex flex-row gap-2">
//           <p className="text-[#ff0000] text-sm sm:text-md"> CATEGORY:</p>
//           <p className="text-sm sm:text-md text-gray-500 mb-3">
//             {post.categories.map((cat: any) => cat.name).join(", ")}
//           </p>
//         </div>
